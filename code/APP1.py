...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Capture.setGeometry(QtCore.QRect(590, 360, 121, 51))
        self.Capture.setObjectName("Capture")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(470, 480, 299, 31))
        self.label_3.setAlignment(QtCore.Qt.AlignCenter)
        self.label_3.setObjectName("label_3")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(800, 470, 211, 41))
        ...
        self.label.setGeometry(QtCore.QRect(150, 10, 1019, 41))
        font = QtGui.QFont()
        ...
        self.btn_buahjatuh.setGeometry(QtCore.QRect(470, 530, 299, 61))
        self.btn_buahjatuh.setObjectName("btn_buahjatuh")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(480, 610, 101, 41))
        self.label_6.setAlignment(QtCore.Qt.AlignCenter)
        self.label_6.setObjectName("label_6")
        self.val_buahjatuh = QtWidgets.QLabel(self.centralwidget)
        self.val_buahjatuh.setGeometry(QtCore.QRect(600, 610, 101, 41))
        ...
        self.btn_nomorPohon.setGeometry(QtCore.QRect(90, 530, 299, 61))
        self.btn_nomorPohon.setObjectName("btn_nomorPohon")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(90, 480, 299, 31))
        self.label_8.setAlignment(QtCore.Qt.AlignCenter)
        self.label_8.setObjectName("label_8")
        self.val_nomorpohon = QtWidgets.QLabel(self.centralwidget)
        self.val_nomorpohon.setGeometry(QtCore.QRect(220, 610, 101, 41))
        self.val_nomorpohon.setAlignment(QtCore.Qt.AlignCenter)
        self.val_nomorpohon.setObjectName("val_nomorpohon")
        self.label_10 = QtWidgets.QLabel(self.centralwidget)
        self.label_10.setGeometry(QtCore.QRect(100, 610, 101, 41))
        self.label_10.setAlignment(QtCore.Qt.AlignCenter)
        self.label_10.setObjectName("label_10")
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(800, 520, 211, 141))
        self.label_11.setAlignment(QtCore.Qt.AlignCenter)
        self.label_11.setObjectName("label_11")
        self.btn_showtableresult = QtWidgets.QPushButton(self.centralwidget)
        self.btn_showtableresult.setGeometry(QtCore.QRect(1040, 470, 201, 191))
        self.btn_showtableresult.setObjectName("btn_showtableresult")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_showtableresult.setText(_translate("MainWindow", "Input"))
    ...
    def update_image(self, frame):
        self.saved_frame = frame # save current frame
        self.showToUI(frame,self.Camera) # show image to label
        
    
    def capture_image(self):
        self.showToUI(self.saved_frame,self.Camera_2) # show captured image to label
