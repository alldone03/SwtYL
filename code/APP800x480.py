...
class Camera(QThread):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.capture = cv2.VideoCapture(2) # capture video from camera
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow) -> None:
        ...
        self.Camera.setGeometry(QtCore.QRect(10, 0, 381, 249))
        ...
        self.Camera_2.setGeometry(QtCore.QRect(400, 0, 381, 249))
        ...
        self.label_9.setGeometry(QtCore.QRect(540, 260, 141, 161))
        self.label_9.setFrameShape(QtWidgets.QFrame.WinPanel)
        self.label_9.setText("")
        self.label_9.setObjectName("label_9")
        self.widget = QtWidgets.QWidget(self.page)
        self.widget.setGeometry(QtCore.QRect(10, 300, 141, 91))
...
"                border-radius: 20px;")
        ...
        self.btn_processdecision.setGeometry(QtCore.QRect(570, 370, 91, 41))
        self.btn_processdecision.setObjectName("btn_processdecision")
        self.val_nomorpohon = QtWidgets.QLabel(self.page)
        self.val_nomorpohon.setGeometry(QtCore.QRect(170, 360, 91, 41))
        ...
        self.val_buahjatuh.setGeometry(QtCore.QRect(430, 360, 91, 41))
        ...
        self.label_8.setGeometry(QtCore.QRect(160, 260, 111, 161))
        self.label_8.setFrameShape(QtWidgets.QFrame.WinPanel)
        self.label_8.setText("")
        self.label_8.setObjectName("label_8")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.page)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(290, 270, 111, 141))
        ...
        self.Capture.setGeometry(QtCore.QRect(690, 260, 91, 81))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_2.setGeometry(QtCore.QRect(560, 270, 91, 31))
        self.label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_2.setObjectName("label_2")
        self.btn_buahjatuh = QtWidgets.QPushButton(self.page)
        self.btn_buahjatuh.setEnabled(True)
        self.btn_buahjatuh.setGeometry(QtCore.QRect(430, 270, 91, 71))
